...
def get_config() -> Dict[str, Any]:
    ...
    parser.add_argument("--normalize-mol-props", action="store_true", default=True,
    ...
    parser.add_argument("--M-matrix-path", type=str, default="./logs/esol/weighted_diag_matrix.npy",
