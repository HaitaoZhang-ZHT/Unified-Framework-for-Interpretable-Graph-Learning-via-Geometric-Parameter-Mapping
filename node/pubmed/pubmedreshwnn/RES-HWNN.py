...
def parameter_parser():
    ...
    parser.add_argument("--filters", type=int, default=500, help="Filters (neurons) in convolution. ")
    ...
    parser.add_argument("--num-global-seeds", type=int, default=3, help="Number of global seeds to train.")
    ...
    parser.add_argument("--alpha", type=float, default=0.3, help="Alpha parameter for initial residual connection.")
    parser.add_argument("--lamda", type=float, default=2, help="Lambda parameter for beta calculation.")
